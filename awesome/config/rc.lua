...
globalkeys = awful.util.table.join(
    ...
    awful.key({}, "Scroll_Lock", function () awful.util.spawn(lock_cmd) end,
    ...
    -- Sound
    awful.key({ modkey,           }, "KP_Add",  function () awful.util.spawn("pulseaudio-ctl up") end),
    awful.key({ modkey,           }, "KP_Subtract",  function () awful.util.spawn("pulseaudio-ctl down") end),
